                                ...
                                <form
                                    ...
                                    <div class="form-group mb-3">
                                        ...
                                        <select x-model="kategori" class="form-select" id="pi_kategori_pemohon"
                                            ...
                                            <option value="Organisasi">Organisasi / Lembaga Masyarakat atau Yayasan atau
                                                Perusahaan</option>
                                        </select>
                                    </div>
                                    <div id="formOrganisasi" x-show="kategori === 'Organisasi'" x-cloak>
                                        ...
                                        <div class="form-group mb-3">
                                            ...
                                            <input type="text" class="form-control"
                                                name="pi_email_atau_medsos_organisasi">
                                        </div>
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group mb-3">
                                    ...
                                    <div id="formOrangLain" x-show="kategori === 'Orang Lain'" x-cloak>
                                        ...
                                        <div class="form-group mb-3">
                                            ...
                                            <input type="text" class="form-control"
                                                name="pi_alamat_pengguna_informasi">
                                        </div>
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group mb-3">
                                                    <label class="label-form">No HP / Telepon Pemohon <span
                                                            class="text-danger">*</span> </label>
                                                    <input type="text" class="form-control"
                                                        name="pi_no_hp_pengguna_informasi">
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="form-group mb-3">
                                                    ...
                                                    <input type="email" class="form-control"
                                                        name="pi_email_pengguna_informasi">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="form-group mb-3">
                    ...
                    <div class="card e-form-card">
                        ...
                        <div class="card-body ">
                            <form action="{{ url('SistemInformasi/EForm/PermohonanInformasi/storePermohonanInformasi') }}"
                                ...
                                @csrf
                                <div class="form-group mb-3">
                                    <label class="label-form">Informasi yang Dibutuhkan <span class="text-danger">*</span>
                                    </label>
                                ...
                                <div class="form-group">
                                    <label class="label-form">Alamat Sumber Informasi <span class="text-danger">*</span>
                                    </label>
