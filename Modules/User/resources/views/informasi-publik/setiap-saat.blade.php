...
<body>
    ...
    <div class="container">
        <h2 class="fw-bold mt-4 mb-2 text-center text-md-center">Informasi Publik yang Wajib Tersedia Setiap Saat</h2>
        ...
        <div class="mt-2 mb-4 text-gray-600" style="max-width: 1000px; margin: 0 auto;">
            Informasi setiap saat adalah informasi yang wajib diumumkan secara langsung oleh badan publik tanpa perlu
            permohonan karena bersifat mendesak dan dapat mengancam hajat hidup orang banyak atau ketertiban umum,
            seperti bencana alam, wabah penyakit, atau gangguan layanan publik; kewajiban ini diatur dalam Undang-Undang
            No. 14 Tahun 2008 tentang Keterbukaan Informasi Publik, Pasal 10 Ayat 1.
        </div>
                ...
                <table class="table table-stack mb-0" style="border-radius:16px 16px 0 0; overflow:hidden;">
                    <thead>
                        <tr style="background:#233e73; color: #fff;">
                            ...
                            <th class="fw-bold">Nama Informasi Setiap Saat</th>
                            <th style="width: 140px;">Tanggal Informasi</th>
                            <th style="width: 120px;">Dokumen</th>
                        </tr>
                    </thead>
                    <tbody>
                        @foreach ($informasiSetiapSaat as $no => $info)
                            <tr>
