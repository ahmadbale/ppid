...
<body>
    ...
    <div class="container">
        <h2 class="fw-bold mt-4 mb-2 text-center text-md-center">Informasi Publik yang Diumumkan Secara Serta Merta</h2>
        ...
        <div class="mt-2 mb-4 text-gray-600" style="max-width: 1000px; margin: 0 auto;">
            Informasi serta merta adalah informasi yang wajib diumumkan secara langsung oleh badan publik tanpa perlu
                ...
                <table class="table table-stack mb-0" style="border-radius:16px 16px 0 0; overflow:hidden;">
                    <thead>
                        <tr style="background:#233e73; color: #fff;">
                            ...
                            <th class="fw-bold">Nama Informasi Serta Merta</th>
                            <th style="width: 140px;">Tanggal Informasi</th>
                            <th style="width: 120px;">Dokumen</th>
                        </tr>
                    </thead>
                    <tbody>
                        @foreach ($sertaMerta as $no => $info)
                            <tr>
