...
class BeritaDinamisController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('sisfo::AdminWeb.BeritaDinamis.index', [
    ...
    public function getData(Request $request)
    {
        ...
        if ($request->ajax()) {
            return view('sisfo::AdminWeb/BeritaDinamis.data', compact('kategoriBerita', 'search'))->render();
        }
    ...
    {
        return view('sisfo::AdminWeb/BeritaDinamis.create');
    }
    ...
    public function editData($id)
    {
        ...
        return view("sisfo::AdminWeb/BeritaDinamis.update", [
            'kategoriBerita' => $kategoriBerita
        ]);
    }
    ...
    public function detailData($id)
    {
        ...
        return view("sisfo::AdminWeb/BeritaDinamis.detail", [
            'kategoriBerita' => $kategoriBerita,
    ...
    public function deleteData(Request $request, $id)
    {
        if ($request->isMethod('get')) {
            ...
            return view("sisfo::AdminWeb/BeritaDinamis.delete", [
                'kategoriBerita' => $kategoriBerita
            ]);
        }
