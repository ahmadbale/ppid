...
class LhkpnController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('sisfo::AdminWeb/InformasiPublik/LhkpnTahun.index', [
    ...
    public function getData(Request $request)
    {
        ...
        if ($request->ajax()) {
            return view('sisfo::AdminWeb/InformasiPublik/LhkpnTahun.data', compact('lhkpn', 'search'))->render();
        }
    ...
    {
        return view('sisfo::AdminWeb/InformasiPublik/LhkpnTahun.create');
    }
    ...
    public function editData($id)
    {
        ...
        return view('sisfo::AdminWeb/InformasiPublik/LhkpnTahun.update', [
            'lhkpn' => $lhkpn
        ]);
    }
    ...
    public function detailData($id)
    {
        ...
        return view('sisfo::AdminWeb/InformasiPublik/LhkpnTahun.detail', [
            'lhkpn' => $lhkpn,
    ...
    public function deleteData(Request $request, $id)
    {
        if ($request->isMethod('get')) {
            ...
            return view('sisfo::AdminWeb/InformasiPublik/LhkpnTahun.delete', [
                'lhkpn' => $lhkpn
            ]);
        }
