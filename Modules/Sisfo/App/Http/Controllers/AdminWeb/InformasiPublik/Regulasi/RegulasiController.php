...
use Modules\Sisfo\App\Models\Website\InformasiPublik\Regulasi\RegulasiModel;
...
class RegulasiController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view("sisfo::AdminWeb/InformasiPublik/Regulasi.index", [
    ...
    public function getData(Request $request)
    {
        ...
        if ($request->ajax()) {
            return view('sisfo::AdminWeb/InformasiPublik/Regulasi.data', compact('regulasi', 'search'))->render();
        }
    ...
    public function addData()
    {
        ...
        return view("sisfo::AdminWeb/InformasiPublik/Regulasi.create", [
    ...
    public function editData($id)
    {
        ...
        return view("sisfo::AdminWeb/InformasiPublik/Regulasi.update", [
            'regulasi' => $regulasi,
            'kategoriRegulasi' => $kategoriRegulasi
        ]);
    }
    ...
    public function detailData($id)
    {
        ...
        return view("sisfo::AdminWeb/InformasiPublik/Regulasi.detail", [
            'regulasi' => $regulasi,
    ...
    public function deleteData(Request $request, $id)
    {
        if ($request->isMethod('get')) {
            ...
            return view("sisfo::AdminWeb/InformasiPublik/Regulasi.delete", [
                'regulasi' => $regulasi
            ]);
        }
