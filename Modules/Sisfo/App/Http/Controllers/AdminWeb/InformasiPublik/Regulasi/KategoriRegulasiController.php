...
use Modules\Sisfo\App\Models\Website\InformasiPublik\Regulasi\KategoriRegulasiModel;
...
class KategoriRegulasiController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view("sisfo::AdminWeb/InformasiPublik/KategoriRegulasi.index", [
    ...
    public function getData(Request $request)
    {
        ...
        if ($request->ajax()) {
            return view('sisfo::AdminWeb/InformasiPublik/KategoriRegulasi.data', compact('kategoriRegulasi', 'search'))->render();
        }
    ...
    {
        $regulasiDinamis = RegulasiDinamisModel::where('isDeleted', 0)->get();
        return view("sisfo::AdminWeb/InformasiPublik/KategoriRegulasi.create", compact('regulasiDinamis'));
    }
    ...
    public function editData($id)
    {
        ...
        return view("sisfo::AdminWeb/InformasiPublik/KategoriRegulasi.update", [
            'kategoriRegulasi' => $kategoriRegulasi,
            'regulasiDinamis' => $regulasiDinamis
        ]);
    }
    ...
    public function detailData($id)
    {
        ...
        return view("sisfo::AdminWeb/InformasiPublik/KategoriRegulasi.detail", [
            'kategoriRegulasi' => $kategoriRegulasi,
    ...
    public function deleteData(Request $request, $id)
    {
        if ($request->isMethod('get')) {
            ...
            return view("sisfo::AdminWeb/InformasiPublik/KategoriRegulasi.delete", [
                'kategoriRegulasi' => $kategoriRegulasi
            ]);
        }
