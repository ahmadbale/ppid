...
class GetIPInformasiBerkalaController extends Controller
{
    use TraitsController;

    public $breadcrumb = 'Informasi Publik yang Wajib Diumumkan Berkala';
    ...
    public function index(Request $request)
    {
        ...
        $breadcrumb = (object)[
            'title' => 'Informasi Publik yang Wajib Diumumkan Berkala',
            'list' => ['Home', 'Informasi Publik', 'Informasi Berkala']
        ];
        ...
        $activeMenu = 'Informasi Publik Berkala';

        try {
            // Ambil data kategori Informasi Berkala
            $kategoriInformasiBerkala = IpDinamisTabelModel::where('ip_nama_submenu', 'Informasi Berkala')
                ->where('isDeleted', 0)
                ->first();
            ...
            // Ambil semua data menu utama dengan hierarki lengkap untuk kategori Informasi Berkala
            $menuUtamaList = $this->getMenusByKategori($kategoriInformasiBerkala->ip_dinamis_tabel_id, $search);
    ...
    public function getData(Request $request)
    {
        ...
        try {
            ...
            if (!$kategoriInformasiBerkala) {
                ...
                return redirect()->back()->with('error', 'Kategori Informasi Berkala tidak ditemukan');
            }
