...
class GetIPInformasiSertaMertaController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        try {
            ...
            if (!$kategoriInformasiSertaMerta) {
                return view('sisfo::AdminWeb.InformasiPublik.GetIPDinamisTabel.SertaMerta.index', [
    ...
    public function getData(Request $request)
    {
        ...
        try {
            ...
            if (!$kategoriInformasiSertaMerta) {
                if ($request->ajax()) {
                    return view('sisfo::AdminWeb.InformasiPublik.GetIPDinamisTabel.SertaMerta.data', [
                        'kategori' => null,
                        'menuUtamaList' => collect(),
                        'totalDokumen' => 0,
                        'totalData' => 0,
    ...
    public function detailData($id)
    {
        try {
            ...
            return view('sisfo::AdminWeb.InformasiPublik.GetIPDinamisTabel.SertaMerta.detail', [
