...
use Modules\Sisfo\App\Models\Website\LandingPage\MediaDinamis\DetailMediaDinamisModel;
...
class DetailMediaDinamisController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('sisfo::AdminWeb.DetailMediaDinamis.index', [
    ...
    public function getData(Request $request)
    {
        ...
        if ($request->ajax()) {
            return view('sisfo::AdminWeb.DetailMediaDinamis.data', compact('detailMediaDinamis', 'search', 'kategori'))->render();
        }
    ...
    {
        $kategoris = MediaDinamisModel::where('isDeleted', 0)->get();
        return view('sisfo::AdminWeb.DetailMediaDinamis.create', compact('kategoris'));
    }
    ...
    public function editData($id)
    {
        try {
            ...
            return view('sisfo::AdminWeb.DetailMediaDinamis.update', [
                'detailMediaDinamis' => $detailMediaDinamis,
                'kategoris' => $kategoris
            ]);
        } catch (\Exception $e) {
    ...
    public function detailData($id)
    {
            ...
            return view('sisfo::AdminWeb.DetailMediaDinamis.detail', [
   ...
   public function deleteData(Request $request, $id)
    {
        if ($request->isMethod('get')) {
            try {
                ...
                return view('sisfo::AdminWeb.DetailMediaDinamis.delete', [
                    'detailMediaDinamis' => $detailMediaDinamis
                ]);
            } catch (\Exception $e) {
                return response()->json(DetailMediaDinamisModel::responFormatError($e, 'Terjadi kesalahan saat mengambil data'));
