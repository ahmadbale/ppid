...
use Modules\Sisfo\App\Models\Website\LandingPage\KategoriAkses\DetailPintasanLainnyaModel;
...
class DetailPintasanLainnyaController extends Controller
{
     ...
     {
          $pintasanLainnya = PintasanLainnyaModel::where('isDeleted', 0)->get();
        return view("sisfo::AdminWeb/DetailPintasanLainnya.create", compact('pintasanLainnya'));
     }
