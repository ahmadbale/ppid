...
class RegulasiModel extends Model
{
    ...
    public static function createData($request)
    {
        ...
        try {
            ...
            return self::responFormatSukses($regulasi, 'Regulasi berhasil dibuat');
        } catch (\Exception $e) {
            DB::rollBack();
    ...
    public static function updateData($request, $id)
    {
        ...
        try {
            ...
            return self::responFormatSukses($regulasi, 'Regulasi berhasil diperbarui');
        } catch (\Exception $e) {
            DB::rollBack();
