...
<div class="card">
    <div class="card-header d-flex align-items-center justify-content-between">
        ...
        <h3 class="card-title"><strong> Notifikasi Pengajuan Permohonan Perawatan Sarana Prasarana </strong></h3>
    </div>
    <div class="card-body">
        @if($notifikasi->isEmpty())
            ...
            <div class="d-flex flex-column align-items-center justify-content-center"
                ...
                <p style="margin: 0; font-weight: bold; font-size: 18px; text-align: center;">Tidak ada Notifikasi
                    Permohonan Perawatan Sarana Prasarana</p>
            </div>
        @else
            ...
            @foreach($notifikasi as $item)
                <div class="p-3 mb-3 notifikasi-item {{ $item->sudah_dibaca ? 'notifikasi-dibaca' : '' }}"
                    ...
                    <div style="flex: 1;">
                        ...
                        <p style="margin: 0;">Status pemohon: {{ $item->t_permohonan_perawatan->pp_kategori_pemohon ?? 'Data Sudah Dihapus' }}
                        </p>
                        <p style="margin: 0;">Kategori Aduan: {{ $item->t_permohonan_perawatan->pp_kategori_aduan ?? 'Data Sudah Dihapus' }}</p>
                        <p style="margin: 0;">
