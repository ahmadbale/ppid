...
<div class="card">
    <div class="card-header d-flex align-items-center justify-content-between">
        ...
        <h3 class="card-title"><strong> Notifikasi Pengajuan Whistle Blowing System </strong></h3>
    </div>
    <div class="card-body">
            ...
            @foreach($notifikasi as $item)
                <div class="p-3 mb-3 notifikasi-item {{ $item->sudah_dibaca ? 'notifikasi-dibaca' : '' }}"
                    ...
                    <div style="flex: 1;">
                        ...
                        <p style="margin: 0;">Status pemohon: {{ $item->t_wbs->wbs_kategori_pemohon ?? 'Data Sudah Dihapus' }}
                        </p>
                        <p style="margin: 0;">Kategori Aduan: {{ $item->t_wbs->wbs_kategori_aduan ?? 'Data Sudah Dihapus' }}</p>
                        <p style="margin: 0;">
