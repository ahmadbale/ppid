...
<head>
    ...
    <title>Status Whistle Blowing System - PPID Polinema</title>
...
<body>
    <div class="email-wrapper">
        ...
        <div class="email-header">
            ...
            <p class="header-subtitle">Whistle Blowing System</p>
        </div>
        ...
        <div class="email-content">
            ...
            <div class="greeting">
                <h4>Halo, {{ $nama }}!</h4>
                <p>Berikut adalah update status terbaru untuk laporan Whistle Blowing System Anda.</p>
            </div>
            ...
            <!-- Detail Information -->
            <div class="info-card">
                <h6><i class="fas fa-info-circle mr-2"></i>Detail Whistle Blowing System</h6>
