...
<head>
    ...
    <title>Hasil Review Permohonan Informasi - PPID Polinema</title>
...
<body>
    <div class="email-wrapper">
        ...
        <div class="email-header">
            ...
            <p class="header-subtitle">Hasil Review Permohonan Informasi</p>
        </div>
        ...
        <div class="email-content">
            ...
            <div class="greeting">
                <h4>Halo, {{ $nama }}!</h4>
                <p>Berikut adalah hasil review untuk permohonan informasi Anda.</p>
            </div>
            ...
            <div class="jawaban-section">
                <h6><i class="fas fa-reply mr-2"></i>Jawaban Permohonan Informasi</h6>
                
                @if(preg_match('/\.(pdf|doc|docx|jpg|jpeg|png|gif)$/i', $jawaban))
                    <!-- Jika jawaban berupa file -->
                    <div class="file-attachment">
                        <i class="fas fa-file-download"></i>
                        <p>Dokumen jawaban telah dilampirkan dalam email ini</p>
                    </div>
                @else
