...
<head>
    ...
    <title>Hasil Review Permohonan Perawatan - PPID Polinema</title>
...
<body>
    <div class="email-wrapper">
        ...
        <div class="email-header">
            ...
            <p class="header-subtitle">Hasil Review Permohonan Perawatan</p>
        </div>
        ...
        <div class="email-content">
            ...
            <div class="status-container">
                <span class="status-badge {{ $status === 'Disetujui' ? 'status-approved' : 'status-rejected' }}">
                    @if($status === 'Disetujui')
                        <i class="fas fa-check-circle"></i> PERMOHONAN PERAWATAN DISETUJUI
                    @else
                        <i class="fas fa-times-circle"></i> PERMOHONAN PERAWATAN DITOLAK
                    @endif
                </span>
            </div>

            <!-- Detail Permohonan Perawatan -->
            <div class="info-card">
                <h6><i class="fas fa-file-alt"></i> Detail Permohonan Perawatan Sarana Prasarana</h6>
                <div class="info-item">
                    <div class="info-label">Unit Kerja:</div>
                    <div class="info-value">{{ $unitKerja }}</div>
                </div>
                <div class="info-item">
                    <div class="info-label">Perawatan Diusulkan:</div>
                    <div class="info-value">{{ $perawatanYangDiusulkan }}</div>
                </div>
                <div class="info-item">
                    <div class="info-label">Keluhan Kerusakan:</div>
                    <div class="info-value">{{ \Illuminate\Support\Str::limit($keluhanKerusakan, 100) }}</div>
                </div>
                <div class="info-item">
                    <div class="info-label">Lokasi Perawatan:</div>
                    <div class="info-value">{{ $lokasiPerawatan }}</div>
                </div>
                <div class="info-item">
