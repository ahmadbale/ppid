...
<head>
    ...
    <title>Status Permohonan Perawatan Sarana Prasarana - PPID Polinema</title>
...
<body>
    <div class="email-wrapper">
        ...
        <div class="email-header">
            ...
            <p class="header-subtitle">Permohonan Perawatan Sarana Prasarana</p>
        </div>
        ...
        <div class="email-content">
            ...
            <div class="greeting">
                <h4>Halo, {{ $nama }}!</h4>
                <p>Berikut adalah update status terbaru untuk permohonan perawatan sarana prasarana Anda.</p>
            </div>
            ...
            <!-- Detail Information -->
            <div class="info-card">
                <h6><i class="fas fa-info-circle mr-2"></i>Detail Permohonan Perawatan</h6>
            ...
            <div class="keluhan-section">
                <h6><i class="fas fa-exclamation-circle mr-2"></i>Keluhan Kerusakan</h6>
                <p>{{ $keluhanKerusakan }}</p>
            </div>
