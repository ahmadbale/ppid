...
<head>
    ...
    <title>Hasil Review Pengaduan Masyarakat - PPID Polinema</title>
...
<body>
    <div class="email-wrapper">
        ...
        <div class="email-header">
            ...
            <p class="header-subtitle">Hasil Review Pengaduan Masyarakat</p>
        </div>
        ...
        <div class="email-content">
            ...
            <div class="status-container">
                <span class="status-badge {{ $status === 'Disetujui' ? 'status-approved' : 'status-rejected' }}">
                    @if($status === 'Disetujui')
                        <i class="fas fa-check-circle"></i> PENGADUAN MASYARAKAT DISETUJUI
                    @else
                        <i class="fas fa-times-circle"></i> PENGADUAN MASYARAKAT DITOLAK
                    @endif
                </span>
            </div>
            ...
            <!-- Detail Pengaduan -->
            <div class="info-card">
                <h6><i class="fas fa-file-alt"></i> Detail Pengaduan Masyarakat</h6>
                <div class="info-item">
