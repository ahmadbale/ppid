...
<head>
    ...
    <title>Hasil Review Whistle Blowing System - PPID Polinema</title>
...
<body>
    <div class="email-wrapper">
        ...
        <div class="email-header">
            ...
            <p class="header-subtitle">Hasil Review Whistle Blowing System</p>
        </div>
        ...
        <div class="email-content">
            ...
            <div class="status-container">
                <span class="status-badge {{ $status === 'Disetujui' ? 'status-approved' : 'status-rejected' }}">
                    @if($status === 'Disetujui')
                        <i class="fas fa-check-circle"></i> WHISTLE BLOWING SYSTEM DISETUJUI
                    @else
                        <i class="fas fa-times-circle"></i> WHISTLE BLOWING SYSTEM DITOLAK
                    @endif
                </span>
            </div>
            ...
            <!-- Detail Laporan WBS -->
            <div class="info-card">
                <h6><i class="fas fa-file-alt"></i> Detail Laporan Whistle Blowing System</h6>
                <div class="info-item">
                    <div class="info-label">Jenis Laporan:</div>
                    <div class="info-value">{{ $jenisLaporan }}</div>
                </div>
                <div class="info-item">
                    <div class="info-label">Yang Dilaporkan:</div>
                    <div class="info-value">{{ $yangDilaporkan }}</div>
                </div>
                <div class="info-item">
                ...
                <div class="info-item">
                    ...
                    <div class="info-value">{{ $lokasiKejadian }}</div>
                </div>
                <div class="info-item">
                    <div class="info-label">Waktu Kejadian:</div>
                    <div class="info-value">{{ date('d M Y', strtotime($waktuKejadian)) }}</div>
                </div>
                <div class="info-item">
                    <div class="info-label">Kronologis:</div>
                    <div class="info-value">{{ \Illuminate\Support\Str::limit($kronologisKejadian, 100) }}</div>
                </div>
                <div class="info-item">
            ...
            @if($status === 'Disetujui' && $jawaban)
                ...
                <div class="jawaban-section">
                    <h6><i class="fas fa-reply"></i> Tanggapan/Jawaban</h6>
                    <p>{{ $jawaban }}</p>
            ...
            <div class="confidential-section">
                <h6><i class="fas fa-lock"></i> Kerahasiaan Terjamin</h6>
                <p>Identitas Anda akan dijaga kerahasiaannya sesuai dengan kebijakan Whistle Blowing System PPID Polinema.</p>
            </div>
