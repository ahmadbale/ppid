...
<head>
    ...
    <title>Status Pengaduan Masyarakat - PPID Polinema</title>
...
<body>
    <div class="email-wrapper">
        ...
        <div class="email-header">
            ...
            <p class="header-subtitle">Sistem Pengaduan Masyarakat</p>
        </div>
        ...
        <div class="email-content">
            ...
            <div class="greeting">
                <h4>Halo, {{ $nama }}!</h4>
                <p>Berikut adalah update status terbaru untuk pengaduan masyarakat Anda.</p>
            </div>
            ...
            <!-- Detail Information -->
            <div class="info-card">
                <h6><i class="fas fa-info-circle mr-2"></i>Detail Pengaduan Masyarakat</h6>
                
                <div class="info-item">
                    <div class="info-label">Nama Pengadu</div>
            ...
            <!-- Kronologis Kejadian -->
            <div class="kronologis-section">
                <h6><i class="fas fa-clipboard-list mr-2"></i>Kronologis Kejadian</h6>
                <p>{{ $kronologisKejadian }}</p>
            </div>
