...
<head>
    ...
    <title>Status Pernyataan Keberatan - PPID Polinema</title>
...
<body>
    <div class="email-wrapper">
        ...
        <div class="email-header">
            ...
            <p class="header-subtitle">Sistem Pernyataan Keberatan</p>
        </div>
        ...
        <div class="email-content">
            ...
            <div class="greeting">
                <h4>Halo, {{ $nama }}!</h4>
                <p>Berikut adalah update status terbaru untuk pernyataan keberatan Anda.</p>
            </div>
            ...
            <!-- Detail Information -->
            <div class="info-card">
                <h6><i class="fas fa-info-circle mr-2"></i>Detail Pernyataan Keberatan</h6>
                ...
                <div class="info-item">
                    <div class="info-label">Status Pengaju</div>
                    <div class="info-value">{{ $statusPemohon }}</div>
                </div>
                
                <div class="info-item">
                    <div class="info-label">Alasan Keberatan</div>
