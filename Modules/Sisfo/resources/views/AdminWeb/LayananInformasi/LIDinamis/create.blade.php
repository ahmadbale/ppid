...
<div class="modal-header">
    <h5 class="modal-title">Tambah Layanan Informasi Dinamis Baru</h5>
  ...
  <div class="modal-body">
    <form id="formCreateLIDinamis" action="{{ url($liDinamisUrl . '/createData') }}" method="POST">
      @csrf
  ...
  <script>
    $(document).ready(function () {
      ...
      $('#btnSubmitForm').on('click', function() {
        ...
        const form = $('#formCreateLIDinamis');
