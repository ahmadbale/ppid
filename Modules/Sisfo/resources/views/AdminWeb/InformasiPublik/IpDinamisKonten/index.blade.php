          ...
          <div class="col-md-6 text-right">
            <div class="card-tools">
              ...
              @if(
                ...
                SetHakAksesModel::cekHakAkses(Auth::user()->user_id, $IpdinamisKontenUrl, 'create')
                )
                <button onclick="modalAction('{{ url($IpdinamisKontenUrl . '/addData') }}')" class="btn btn-sm btn-success">
...
<script>
  ...
  var IpdinamisKontenUrl = '{{ $IpdinamisKontenUrl }}';
  ...
  function loadIPDinamisTabelData(page, search) {
    $.ajax({
    url: '{{ url('') }}/' + IpdinamisKontenUrl + '/getData',
    type: 'GET',
    data: {
      page: page,
      search: search
