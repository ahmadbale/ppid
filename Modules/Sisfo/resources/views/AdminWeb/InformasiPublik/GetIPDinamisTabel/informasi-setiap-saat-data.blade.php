    ...
    <div class="table-responsive">
        <table class="table table-bordered table-striped">
            <thead class="bg-primary text-white">
                <tr>
                    <th width="50">No.</th>
                    <th>Nama Informasi Setiap Saat</th>
                ...
                @foreach($menuUtamaList as $menuUtama)
                    ...
                    <tr>
                        ...
                        <td class="text-center">
                            @if($menuUtama->dokumen_ip_mu)
                                <button type="button" 
                                        class="btn btn-sm btn-success view-document-setiap-saat" 
...
@else
    <div class="text-center py-5">
        <div class="empty-state">
            ...
            <p class="text-muted">
                @if(!empty($search))
                    Tidak ditemukan informasi Setiap Saat yang sesuai dengan pencarian "{{ $search }}"
                @else
