          ...
          <div class="col-md-6 text-right">
            <div class="card-tools">
              ...
              @if(
                ...
                SetHakAksesModel::cekHakAkses(Auth::user()->user_id, $IpdinamisTabelUrl, 'create')
                )
                <button onclick="modalAction('{{ url($IpdinamisTabelUrl . '/addData') }}')" class="btn btn-sm btn-success">
