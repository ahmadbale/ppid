        ...
        <div class="col-md-6 text-right">
          <div class="card-tools">
            @if(
              ...
              SetHakAksesModel::cekHakAkses(Auth::user()->user_id, $webMenuGlobalPath, 'create')
            )
              <button onclick="modalAction('{{ url($webMenuGlobalPath . '/addData') }}')" class="btn btn-sm btn-success">
      ...
      <div class="row mb-3">
        <div class="col-md-6">
          <form id="searchForm" class="d-flex">
            <input type="text" name="search" class="form-control" placeholder="Cari nama menu, URL..."
              value="{{ $search ?? '' }}">
  ...
  <script>
    $(document).ready(function () {
      ...
      $('#searchForm').on('submit', function (e) {
        ...
        loadWebMenuGlobalData(1, search);
      });
      ...
      $(document).on('click', '.pagination a', function (e) {
        ...
        loadWebMenuGlobalData(page, search);
      });

      // Fungsi untuk memuat data Menu Global
      function loadWebMenuGlobalData(page, search) {
        $.ajax({
          url: '{{ url('') }}/' + webMenuGlobalPath + '/getData',
          type: 'GET',
          data: {
            page: page,
            search: search
      ...
      window.reloadTable = function() {
        ...
        var search = $('#searchForm input[name="search"]').val();
        loadWebMenuGlobalData(currentPage, search);
      }
    });
  </script>
@endpush