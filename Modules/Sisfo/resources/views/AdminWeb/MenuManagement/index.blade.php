...
@push('css')
    <link rel="stylesheet" href="{{ asset('modules/sisfo/vendor/nestable2/jquery.nestable.min.css') }}">
    <link rel="stylesheet" href="{{ asset('modules/sisfo/vendor/toastr/toastr.min.css') }}">
    <style>
        .is-invalid {
...
@push('js')
    <script src="{{ asset('modules/sisfo/vendor/jquery/jquery.min.js') }}"></script>
    <script src="{{ asset('modules/sisfo/vendor/nestable2/jquery.nestable.min.js') }}"></script>
    <script src="{{ asset('modules/sisfo/vendor/toastr/toastr.min.js') }}"></script>
