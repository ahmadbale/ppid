@php
    ...
    // Ambil hak akses user dari session
...
{{-- Digunakan untuk render nested menu structure dalam drag-drop list --}}
    ...
    <li class="dd-item" data-id="{{ $menu->web_menu_id }}" data-level="{{ $menu->fk_m_hak_akses }}"
        ...
        @if ($menu->children->count() > 0)
            <ol class="dd-list">
                ...
                @include('sisfo::AdminWeb.MenuManagement.data', ['menus' => $menu->children, 'kode' => $contexthakAksesKode])
            </ol>
        @endif
    </li>
@endforeach