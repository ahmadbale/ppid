...
<script>
$(function() {
    // Variable untuk menyimpan level menu asli untuk validasi
    let originalMenuLevel = '';

    // Event handler untuk dropdown Hak Akses di form edit
    ...
    // Form editMenu - gunakan .off() untuk mencegah binding ganda
        ...
        $.ajax({
            ...
            error: function(xhr) {
                ...
                if (xhr.status === 422) {
                    ...
                    toastr.error('Error saat mengupdate menu: ' + xhr.statusText);
                }
            }
        });
    });
