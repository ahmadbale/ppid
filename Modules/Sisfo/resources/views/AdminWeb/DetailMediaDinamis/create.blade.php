    ...
    <form id="formCreateDetailMediaDinamis" action="{{ url('adminweb/media-detail/createData') }}" method="POST"
        ...
        <div class="form-group" id="linkUrlDiv" style="display: none;">
            ...
            <input type="url" class="form-control" id="dm_media_upload_link"
                name="t_detail_media_dinamis[dm_media_upload]" placeholder="Contoh: https://www.example.com"
                pattern="https?://.+">
    ...
    $(document).ready(function() {
        ...
        $('#btnSubmitForm').on('click', function() {
            ...
            if ($('#fk_m_media_dinamis').val() === '') {
                ...
                $('#fk_m_media_dinamis_error').html('Kategori Media wajib diisi.');
            }
            ...
            // Validasi Tipe Media
            if ($('#dm_type_media').val() === '') {
                isValid = false;
                $('#dm_type_media').addClass('is-invalid');
                $('#dm_type_media_error').html('Tipe Media wajib dipilih.');
            }
            ...
            if (mediaType === 'file' && !$('#media_file').val()) {
                isValid = false;
                $('#media_file').addClass('is-invalid');
                $('#media_file_error').html('File Media wajib dipilih.');
            }
