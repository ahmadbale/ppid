...
@section('content')
    <div class="card">
        ...
        <div class="card-body">
            ...
            <form id="permohonanForm" action="{{ url('SistemInformasi/EForm/' . Auth::user()->level->level_kode . '/PermohonanPerawatan/createData') }}" method="POST" enctype="multipart/form-data" novalidate>
                @csrf
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="pp_nama_pengguna" name="t_permohonan_perawatan[pp_nama_pengguna]" value="{{ old('t_permohonan_perawatan.pp_nama_pengguna') }}">
                    <div class="invalid-feedback" id="f_pp_nama_pengguna_error">Nama Lengkap Pengusul tidak boleh kosong.</div>
                </div>

                <div class="form-group">
                    <label for="pp_no_hp_pengguna">Nomor HP Pengusul<span class="text-danger">*</span></label>
                    <input type="number" class="form-control" id="pp_no_hp_pengguna" name="t_permohonan_perawatan[pp_no_hp_pengguna]" value="{{ old('t_permohonan_perawatan.pp_no_hp_pengguna') }}" maxlength="12">
                    <div class="invalid-feedback" id="f_pp_no_hp_pengguna_error">Nomor HP Pengusul tidak boleh kosong.</div>
                </div>
                
                <div class="form-group">
                    <label for="pp_email_pengguna">Email Pengusul<span class="text-danger">*</span></label>
                    <input type="email" class="form-control" id="pp_email_pengguna" name="t_permohonan_perawatan[pp_email_pengguna]" value="{{ old('t_permohonan_perawatan.pp_email_pengguna') }}">
                    <div class="invalid-feedback" id="f_pp_email_pengguna_error">Email Pengusul tidak boleh kosong.</div>
                </div>
                <div class="form-group">
                    <label for="pp_unit_kerja">Unit Kerja Pengusul <span class="text-danger">*</span></label>
                    <input type="text" class="form-control" id="pp_unit_kerja" name="t_permohonan_perawatan[pp_unit_kerja]" value="{{ old('t_permohonan_perawatan.pp_unit_kerja') }}">
                ...
                <div class="form-group">
                    ...
                    <select class="form-control" id="pp_perawatan_yang_diusulkan" name="t_permohonan_perawatan[pp_perawatan_yang_diusulkan]" required>
                    ...
                    <div class="invalid-feedback" id="f_pp_perawatan_yang_diusulkan_error">Jenis Perawatan harus dipilih.</div>
                </div>

                <div class="form-group">
                    <label for="pp_keluhan_kerusakan">Keluhan Kerusakan<span class="text-danger">*</span></label>
                    <input type="text" class="form-control" id="pp_keluhan_kerusakan" name="t_permohonan_perawatan[pp_keluhan_kerusakan]" required value="{{ old('t_permohonan_perawatan.pp_keluhan_kerusakan') }}">
                    <div class="invalid-feedback" id="f_pp_keluhan_kerusakan_error">Keluhan Kerusakan tidak boleh kosong.</div>
                </div>

                <div class="form-group">
                    <label for="pp_lokasi_perawatan">Lokasi Perawatan<span class="text-danger">*</span></label>
                    <input type="text" class="form-control" id="pp_lokasi_perawatan" name="t_permohonan_perawatan[pp_lokasi_perawatan]" value="{{ old('t_permohonan_perawatan.pp_lokasi_perawatan') }}">
                    <div class="invalid-feedback" id="f_pp_lokasi_perawatan_error">Lokasi Perawatan tidak boleh kosong.</div>
                </div>

                <div class="form-group">
                    <label for="pp_foto_kondisi">Foto Kondisi (Opsional)</label>
                    <input type="file" class="form-control" id="pp_foto_kondisi" name="pp_foto_kondisi" accept="file/*">
                    <div class="invalid-feedback" id="f_pp_foto_kondisi_error">Unggah Foto Kondisi jika diperlukan.</div>
                </div>

                <div class="form-group">
                    <label for="pp_bukti_aduan">Upload Bukti Aduan <span class="text-danger">*</span></label>
                    <input type="file" class="form-control" id="pp_bukti_aduan" name="pp_bukti_aduan" accept="file/*">
                    <div class="invalid-feedback" id="f_pp_bukti_aduan_error">Bukti Aduan harus diunggah.</div>
                </div>
    ...
    @push('js')
        <script>
            $(document).ready(function () {
                ...
                $('#permohonanForm').submit(function(e) {
                    ...
                    $('#pp_nama_pengguna, #pp_no_hp_pengguna, #pp_email_pengguna, #pp_unit_kerja, #pp_perawatan_yang_diusulkan, #pp_keluhan_kerusakan, #pp_lokasi_perawatan, #pp_bukti_aduan').each(function() {
                        if ($(this).val() === '') {
                            isValid = false;
        ...
        if (phoneNumber.length > 12) {
            ...
            $('#f_pp_no_hp_pengguna_error').text('Nomor HP Pengusul harus terdiri dari maksimal 12 digit.').show();
        }
