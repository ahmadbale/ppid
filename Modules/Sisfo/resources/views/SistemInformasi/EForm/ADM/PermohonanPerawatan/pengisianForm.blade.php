    ...
    <div class="card">
        ...
        <div class="card-body">
            ...
            <form
                ...
                <div class="form-group">
                    ...
                    <input type="text"
                        class="form-control @error('t_permohonan_perawatan.pp_nama_pengguna') is-invalid @enderror"
                ...
                <div class="form-group col-md-6">
                    ...
                    <input type="text"
                        class="form-control @error('t_permohonan_perawatan.pp_no_hp_pengguna') is-invalid @enderror"
                ...
                <div class="form-group col-md-6">
                    ...
                    <input type="email"
                        class="form-control @error('t_permohonan_perawatan.pp_email_pengguna') is-invalid @enderror"
        ...
        <div class="form-group">
            ...
            <select class="form-control @error('t_permohonan_perawatan.pp_perawatan_yang_diusulkan') is-invalid @enderror"
                id="pp_perawatan_yang_diusulkan" name="t_permohonan_perawatan[pp_perawatan_yang_diusulkan]" required>
                ...
                <option value="Alat Besar"
                    {{ old('t_permohonan_perawatan.pp_perawatan_yang_diusulkan') == 'Alat Besar' ? 'selected' : '' }}>Alat
                    Besar</option>
                ...
                <option value="Alat Peraga"
                    {{ old('t_permohonan_perawatan.pp_perawatan_yang_diusulkan') == 'Alat Peraga' ? 'selected' : '' }}>Alat
                    Peraga</option>
        ...
        <div class="form-group">
            ...
            <input type="text"
                class="form-control @error('t_permohonan_perawatan.pp_keluhan_kerusakan') is-invalid @enderror"
                id="pp_keluhan_kerusakan" name="t_permohonan_perawatan[pp_keluhan_kerusakan]" required
                rows="4"{{ old('t_permohonan_perawatan.pp_keluhan_kerusakan') }}>
        ...
        <div class="form-group">
            ...
            <input type="text"
                class="form-control @error('t_permohonan_perawatan.pp_lokasi_perawatan') is-invalid @enderror"
        ...
        <div class="form-group">
            ...
            <small class="text-muted d-block mb-2">Unggah foto kondisi jika diperlukan</small>
            <div class="custom-file">
                <input type="file" class="custom-file-input @error('pp_foto_kondisi') is-invalid @enderror"
                    id="pp_foto_kondisi" name="pp_foto_kondisi">
                <label class="custom-file-label" for="pp_foto_kondisi">Pilih file (PDF, Gambar, dll)</label>
            </div>
        ...
        <div class="form-group">
            ...
            <div class="custom-file">
                <input type="file" class="custom-file-input @error('pp_bukti_aduan') is-invalid @enderror"
                    id="pp_bukti_aduan" name="pp_bukti_aduan">
                <label class="custom-file-label" for="pp_bukti_aduan">Pilih file (PDF, Gambar, dll)</label>
            </div>
        ...
        <div class="alert alert-info mt-3 mb-4">
            <p class="mb-0"><strong>Catatan:</strong> Dengan mengajukan laporan ini, Anda menyatakan bahwa informasi yang
                diberikan adalah benar dan Anda bersedia memberikan keterangan lebih lanjut jika diperlukan.</p>
        </div>

        <div class="form-group">
            <div class="custom-control custom-checkbox">
                <input type="checkbox" class="custom-control-input" id="persetujuan" required>
                <label class="custom-control-label" for="persetujuan">Saya menyatakan bahwa informasi yang saya berikan
