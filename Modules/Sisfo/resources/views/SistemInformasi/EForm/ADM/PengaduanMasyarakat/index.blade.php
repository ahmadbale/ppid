...
$data = app()->call([app('Modules\Sisfo\App\Http\Controllers\SistemInformasi\EForm\PengaduanMasyarakatController'), 'getData']);
...
@endsection --}}
    ...
    <div class="card card-outline">
        <div class="card-body">
            <h5 class="mb-3 text-bold">Jumlah Pengaduan Masyarakat</h5>
            <div class="row text-center">
                <div class="col">
    ...
    <div class="card card-outline ">
        <div class="card-body">
            <h5 class="mb-3 text-bold">Daftar Pengaduan Masyarakat</h5>
            <div class="row mb-4">
                <div class="col-md-6">
