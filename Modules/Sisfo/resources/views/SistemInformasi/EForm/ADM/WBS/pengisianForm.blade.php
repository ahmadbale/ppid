        ...
        <div class="card-body">
            ...
            <form action="{{ url('SistemInformasi/EForm/' . Auth::user()->level->level_kode . '/WBS/createData') }}" method="POST"
                ...
                <div class="form-group">
                    <label for="wbs_nama_tanpa_gelar">Nama Lengkap Pelapor<span class="text-danger">*</span></label>
                    <small class="tetx-muted d-block mb-2">Tanpa Gelar</small>
            ...
            <div class="form-group">
                <label for="wbs_nik_pengguna">Upload Foto Kartu Identitas Pelapor <span class="text-danger">*</span></label>
                ...
                <div class="custom-file">
                    <input type="file"
                        class="custom-file-input @error('t_wbs.wbs_nik_pengguna') is-invalid @enderror"
                        id="wbs_nik_pengguna"
                        name="t_wbs[wbs_nik_pengguna]"
                        accept="image/*">
                    <label class="custom-file-label" for="wbs_nik_pengguna">Pilih file (PNG, JPG)</label>
                </div>
            ...
            <hr>
                ...
                <div class="form-group">
                    <label for="wbs_bukti_pendukung">Upload Bukti Pendukung <span class="text-danger">*</span></label>
                    <small class="text-muted d-block mb-2">maks. 100mb</small>
                    <div class="custom-file">
                        <input type="file"
                            class="custom-file-input @error('wbs_bukti_pendukung') is-invalid @enderror"
                            id="wbs_bukti_pendukung" name="wbs_bukti_pendukung">
                        <label class="custom-file-label" for="wbs_bukti_pendukung">Pilih file (PDF, Gambar, mp4, dll)</label>
                    </div>
                ...
                <div class="form-group">
                    ...
                    <div class="custom-file">
                        <input type="file"
                            class="custom-file-input @error('wbs_bukti_aduan') is-invalid @enderror"
                            id="wbs_bukti_aduan" name="wbs_bukti_aduan">
                        <label class="custom-file-label" for="wbs_bukti_aduan">Pilih file (PDF, Gambar, mp4, dll)</label>
                    </div>
