...
@section('content')
    <div class="card">
        ...
        <div class="card-body">
            ...
            <form id="permohonanForm"  action="{{ url('SistemInformasi/EForm/' . Auth::user()->level->level_kode . '/PermohonanInformasi/createData') }}" method="POST"
...
<script>
    $(document).ready(function () {
        ...
        $('#permohonanForm').on('submit', function (e) {
            ...
            // Validate Orang Lain Fields
            if (kategoriPemohon === 'Orang Lain') {
                isValid &= validateField('#pi_nama_pengguna_penginput', '#f_pi_nama_pengguna_penginput_error');
                isValid &= validateField('#pi_alamat_pengguna_penginput', '#f_pi_alamat_pengguna_penginput_error');
                isValid &= validateField('#pi_no_hp_pengguna_penginput', '#f_pi_no_hp_pengguna_penginput_error');
                isValid &= validateField('#pi_email_pengguna_penginput', '#f_pi_email_pengguna_penginput_error');
                isValid &= validateFile('#pi_upload_nik_pengguna', '#f_pi_upload_nik_pengguna_error');

                isValid &= validateField('#pi_nama_pengguna_informasi', '#f_pi_nama_pengguna_informasi_error');
                isValid &= validateField('#pi_alamat_pengguna_informasi', '#f_pi_alamat_pengguna_informasi_error');
                isValid &= validateField('#pi_no_hp_pengguna_informasi', '#f_pi_no_hp_pengguna_informasi_error');
                isValid &= validateField('#pi_email_pengguna_informasi', '#f_pi_email_pengguna_informasi_error');
                isValid &= validateFile('#pi_upload_nik_pengguna_informasi', '#f_pi_upload_nik_pengguna_informasi_error');
            }

            // Validate Organisasi Fields
            if (kategoriPemohon === 'Organisasi') {
                ...
                isValid &= validateField('#pi_email_atau_medsos_organisasi', '#f_pi_email_atau_medsos_organisasi_error');
