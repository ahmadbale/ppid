            ...
            <form action="{{ url('SistemInformasi/EForm/' . Auth::user()->level->level_kode . '/PernyataanKeberatan/createData') }}" method="POST"
                ...
                <div id="formDiriSendiri" style="display: none;">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text"
                            class="form-control @error('t_form_k_diri_sendiri.pk_nama_pengguna') is-invalid @enderror"
                    ...
                    <div class="form-group">
                        ...
                        <input type="text"
                            class="form-control @error('t_form_pk_diri_sendiri.pk_alamat_pengguna') is-invalid @enderror"
                    ...
                    <div class="row">
                        <div class="form-group col-md-6">
                            ...
                            <input type="text"
                                class="form-control @error('t_form_pk_diri_sendiri.pk_no_hp_pengguna') is-invalid @enderror"
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <input type="email"
                                class="form-control @error('t_form_pk_diri_sendiri.pk_email_pengguna') is-invalid @enderror"
                    ...
                    <div class="form-group">
                        <label for="pk_upload_nik_pengguna">Upload Foto Kartu Identitas Pelapor<span
                        ...
                        <div class="custom-file">
                            <input type="file"
                                class="custom-file-input @error('pk_upload_nik_pengguna') is-invalid @enderror"
                ...
                <div id="formOrangLain" style="display: none;">
                    ...
                    <div class="form-group">
                        <label for="pk_upload_nik_pengguna_penginput">Upload Foto Kartu Identitas Pelapor<span
                                class="text-danger">*</span></label>
                        <small class="text-muted d-block mb-2">
                        ...
                        <div class="custom-file">
                            <input type="file"
                                class="custom-file-input @error('pk_upload_nik_pengguna_penginput') is-invalid @enderror"
                    ...
                    <div class="form-group">
                        <label for="pk_upload_nik_kuasa_pemohon">Upload Foto Kartu Identitas Pemohon<span
                                class="text-danger">*</span></label>
                        <small class="text-muted d-block mb-2">
                            Silakan scan / foto kartu identitas (KTP/SIM/Paspor) pemohon. Semua data pada kartu identitas
                            harus tampak jelas dan terang.
                        ...
                        <div class="custom-file">
                            <input type="file"
                                class="custom-file-input @error('pk_upload_nik_kuasa_pemohon') is-invalid @enderror"
                ...
                <div class="form-group">
                    ...
                    <div class="custom-file">
                        <input type="file"
                            class="custom-file-input @error('pk_bukti_aduan') is-invalid @enderror"
                            id="pk_bukti_aduan" name="pk_bukti_aduan">
                        <label class="custom-file-label" for="pk_bukti_aduan">Pilih file (PDF, Gambar, dll)</label>
                    </div>
