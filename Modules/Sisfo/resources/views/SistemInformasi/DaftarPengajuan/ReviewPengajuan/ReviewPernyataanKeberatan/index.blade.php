...
@push('js')
    <script>
        $(function() {
            ...
            const baseUrl = '{{ url(\Modules\Sisfo\App\Models\Website\WebMenuModel::getDynamicMenuUrl("daftar-review-pengajuan-pernyataan-keberatan")) }}';
            
            // Fungsi untuk menampilkan modal update (approve/decline)
            window.showUpdateModal = function(id, type) {
                // Reset modal content
                const title = type === 'approve' ? 'Persetujuan Review Pernyataan Keberatan' : 'Penolakan Review Pernyataan Keberatan';
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        ...
                        $('#btnConfirmUpdate').on('click', function() {
                            ...
                            if (action === 'approve') {
                                processApproval(pernyataanKeberatanId);
                            } else {
                                processDecline(pernyataanKeberatanId);
                            }
                        });
                    },
                    error: function(xhr) {
            ...
            // Fungsi helper untuk proses approval dengan upload file
            ...
            window.hapusReview = function(id, sudahDibaca) {
                ...
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        ...
                        // Kirim permintaan AJAX dengan method DELETE
                        $.ajax({
