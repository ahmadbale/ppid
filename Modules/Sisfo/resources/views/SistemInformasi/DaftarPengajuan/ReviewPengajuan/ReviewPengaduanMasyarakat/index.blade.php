...
@push('js')
    <script>
        $(function() {
            ...
            const baseUrl = '{{ url(\Modules\Sisfo\App\Models\Website\WebMenuModel::getDynamicMenuUrl("daftar-review-pengajuan-pengaduan-masyarakat")) }}';
            
            // Fungsi untuk menampilkan modal update (approve/decline)
            window.showUpdateModal = function(id, type) {
                // Reset modal content
                const title = type === 'approve' ? 'Persetujuan Review Pengaduan' : 'Penolakan Review Pengaduan';
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        ...
                        $('#btnConfirmUpdate').on('click', function() {
                            ...
                            if (action === 'approve') {
                                processApproval(pengaduanId);
                            } else {
                                processDecline(pengaduanId);
                            }
                        });
                    },
                    error: function(xhr) {
            ...
            function processApproval(id) {
                ...
                Swal.fire({
                    title: 'Konfirmasi',
                    text: 'Anda yakin sudah mereview data dan akan menyetujui review pengaduan masyarakat ini?',
                    icon: 'question',
            ...
            function processDecline(id) {
                ...
                Swal.fire({
                    title: 'Konfirmasi',
                    text: 'Jika anda yakin telah melakukan review dan akan menolak pengaduan masyarakat ini dengan alasan yang telah diisi?',
                    icon: 'question',
                    showCancelButton: true,
