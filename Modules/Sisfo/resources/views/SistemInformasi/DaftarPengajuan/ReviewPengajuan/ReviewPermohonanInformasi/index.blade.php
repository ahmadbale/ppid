...
@push('js')
    <script>
        $(function() {
            ...
            const baseUrl = '{{ url(\Modules\Sisfo\App\Models\Website\WebMenuModel::getDynamicMenuUrl("daftar-review-pengajuan-permohonan-informasi")) }}';
            
            // Fungsi untuk menampilkan modal update (approve/decline)
            window.showUpdateModal = function(id, type) {
                // Reset modal content
                const title = type === 'approve' ? 'Persetujuan Permohonan' : 'Penolakan Permohonan';
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        ...
                        $('#btnConfirmUpdate').on('click', function() {
                            ...
                            if (action === 'approve') {
                                processApproval(permohonanId);
                            } else {
                                processDecline(permohonanId);
                            }
                        });
                    },
                    error: function(xhr) {
