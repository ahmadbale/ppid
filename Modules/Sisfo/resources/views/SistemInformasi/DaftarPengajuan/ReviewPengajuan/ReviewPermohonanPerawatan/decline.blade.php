<div class="modal-body">
    <div class="alert alert-warning">
        <i class="fas fa-exclamation-triangle mr-2"></i> Anda akan menolak review permohonan perawatan dari 
    ...
    <form id="formTolakModal">
        <div class="form-group">
            ...
            <textarea class="form-control" id="alasan_penolakan_modal" name="alasan_penolakan" rows="4"
                placeholder="Masukkan alasan penolakan review permohonan perawatan ini..." required></textarea>
...
<div class="modal-footer">
    ...
    <button type="button" id="btnConfirmDecline" data-id="{{ $permohonanPerawatan->permohonan_perawatan_id }}" class="btn btn-danger">
