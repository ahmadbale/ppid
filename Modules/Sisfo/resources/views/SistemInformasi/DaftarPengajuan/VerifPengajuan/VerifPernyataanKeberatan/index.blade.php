...
<div class="card card-primary card-outline">
    <div class="card-header">
        <h3 class="card-title">Daftar Verifikasi Pengajuan Pernyataan Keberatan</h3>
    </div>
    <div class="card-body">
        <div class="mb-3">
        ...
        @if(count($pernyataanKeberatan) > 0)
            <div class="table-responsive">
                @include('sisfo::SistemInformasi.DaftarPengajuan.VerifPengajuan.VerifPernyataanKeberatan.data')
            </div>
        @else
            <div class="alert alert-info">
                <i class="fas fa-info-circle mr-2"></i> Tidak ada data Pernyataan Keberatan yang perlu diverifikasi.
            </div>
        @endif
    </div>
</div>
