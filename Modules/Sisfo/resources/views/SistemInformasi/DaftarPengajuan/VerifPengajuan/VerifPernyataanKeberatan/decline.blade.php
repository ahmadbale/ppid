<div class="modal-body">
    <div class="alert alert-warning">
        <i class="fas fa-exclamation-triangle mr-2"></i> Anda akan menolak Pernyataan Keberatan dari
        <strong>
...
<div class="modal-footer">
    ...
    <button type="button" id="btnConfirmDecline" data-id="{{ $pernyataanKeberatan->pernyataan_keberatan_id }}"
        class="btn btn-danger">
        <i class="fas fa-times mr-1"></i> Tolak Pernyataan Keberatan
    </button>
</div>