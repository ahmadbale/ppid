{{-- filepath: c:\laragon\www\PPID-polinema\Modules\Sisfo\resources\views\SistemInformasi\DaftarPengajuan\VerifPengajuan\VerifPengaduanMasyarakat\data.blade.php --}}
                                    ...
                                    <tr>
                                        ...
                                        <td>: 
                                            @if($PM->pm_upload_nik_pengguna)
                                                <a href="{{ asset('storage/' . $PM->pm_upload_nik_pengguna) }}" target="_blank" class="btn btn-sm btn-info">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12">
                                ...
                                @if($PM->pm_bukti_pendukung)
                                    <a href="{{ asset('storage/' . $PM->pm_bukti_pendukung) }}" target="_blank" class="btn btn-info">
                            ...
                            <div class="card-body">
                                <table class="table table-borderless table-sm">
                                    ...
                                    <tr>
                                        ...
                                        <td>: {{ $PM->pm_tanggal_dibaca ? \Carbon\Carbon::parse($PM->pm_tanggal_dibaca)->format('d-m-Y H:i:s') : '-' }}</td>
                                    </tr>
                                </table>
                            </div>
                        </div>
            ...
            <div class="row">
                <div class="col-12">
                    <div class="d-flex flex-wrap">
                        @if($PM->pm_status == 'Masuk')
                            <button type="button" class="btn btn-success btn-sm mr-2 mb-2" onclick="showUpdateModal({{ $PM->pengaduan_masyarakat_id }}, 'approve')">
                                <i class="fas fa-check"></i> Setujui
                            </button>
                            <button type="button" class="btn btn-danger btn-sm mr-2 mb-2" onclick="showUpdateModal({{ $PM->pengaduan_masyarakat_id }}, 'decline')">
                                <i class="fas fa-times"></i> Tolak
                            </button>
                        @endif

                        <button class="btn btn-info btn-sm mr-2 mb-2" onclick="tandaiDibaca({{ $PM->pengaduan_masyarakat_id }}, '{{ $PM->pm_status }}', {{ $PM->pm_sudah_dibaca ? 'true' : 'false' }})" 
                            data-status="{{ $PM->pm_status }}" data-dibaca="{{ $PM->pm_sudah_dibaca ? 'true' : 'false' }}">
                            <i class="fas fa-book-reader"></i> Tandai Dibaca
                        </button>
                        
                        <button class="btn btn-warning btn-sm mb-2" onclick="hapusPermohonan({{ $PM->pengaduan_masyarakat_id }}, {{ $PM->pm_sudah_dibaca ? 'true' : 'false' }})" 
                            data-dibaca="{{ $PM->pm_sudah_dibaca ? 'true' : 'false' }}">
