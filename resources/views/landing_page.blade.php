...
<body>
    ...
    <section class="akses-menu-cepat" style="background-color: #ffffff; margin: 100px 0">
        <div class="container text-center" style=" margin: 50px auto; ">
            ...
            <div class="menu-container">
                <div class="menu-row">
                    <div class="menu-item" onclick="window.location.href='{{ route('informasi-publik.setiap-saat') }}'">
                        <div class="icon-wrapper">
                            <img src="{{ asset('img/24-hours.svg')}}" class="icon static" alt="Informasi Setiap Saat">
                            <img src="{{ asset('img/24-hours.gif')}}" class="icon animated" alt="Informasi Setiap Saat">
                        </div>
                    ...
                    <div class="menu-item" onclick="window.location.href='{{ route('informasi-publik.serta-merta') }}'">
                        <div class="icon-wrapper">
                            <img src="{{ asset('img/website.svg')}}" class="icon static" alt="Informasi Serta Merta">
                            <img src="{{ asset('img/website.gif')}}" class="icon animated" alt="Informasi Serta Merta">
                        </div>
                    ...
                    <div class="menu-item" onclick="window.open('https://helpakademik.polinema.ac.id/', '_blank')">
                        <div class="icon-wrapper">
                            <img src="{{ asset('img/mba-helpdesk.svg')}}" class="icon static" alt="HELPDESK Akademik">
                            <img src="{{ asset('img/helpdesk.gif')}}" class="icon animated" alt="HELPDESK Akademik">
                        </div>
                ...
                <div class="menu-item" onclick="window.open('https://kemdikbud.lapor.go.id/', '_blank')">
                    <div class="icon-wrapper">
                        <img src="{{ asset('img/laporKemdikbud.svg')}}" class="icon static" alt="Lapor KEMDIKBUD">
                        <img src="{{ asset('img/laporKemdikbud.svg')}}" class="icon animated" alt="Lapor KEMDIKBUD">
                    </div>
    ...
    <div class="masuktamu-container">
        <div class="masuktamu-text">
            ...
            <button class="masuk-button" onclick="window.location.href='{{ route('login') }}'">Ajukan Permohonan</button>
            </div>
